...
void ConfigSystem::SetupVisuals()
{
	...
	SetupValue(g_Options.chams_player_type_layer, 1, ("player-chams"), ("chams_type_layer"));
	SetupValue(g_Options.chams_player_enabled_l, false, ("player-chams"), ("chams_enabled_layer"));
	...
	SetupValue(g_Options.chams_hands_enabled_l, false, ("player-chams"), ("chams_enabled_layer__"));
	SetupValue(g_Options.chams_arms_type_layer, 1, ("player-arms"), ("arms_type_layer"));
	...
	SetupValue(g_Options.chams_weapon_enabled_l, false, ("player-chams"), ("chams_enabled_layer___"));
	SetupValue(g_Options.chams_arms_type, 1, ("player-weapon"), ("chams_weapon_type"));
	SetupValue(g_Options.chams_arms_type_layer, 1, ("player-weapon"), ("chams_weapon_type_layer"));
	SetupValue(g_Options.chams_weapon_enabled_l, 1, ("player-weapon"), ("chams_weapon_type_enabled"));
...
void ConfigSystem::SetupColors()
{
	...
	SetupColor(g_Options.color_chams_player_enemy_visible_l, "color_player_chams_player_enemy_visible_layer");
	SetupColor(g_Options.color_chams_arms_visible, "color_arms");
	SetupColor(g_Options.color_chams_weapons, "color_weapons");
	SetupColor(g_Options.color_chams_arms_visible_layer, "color_arms_layer");
	SetupColor(g_Options.color_chams_weapons_layer, "color_weapons_layer");
